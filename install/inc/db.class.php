    ...
    public function connect() {
      ...
      if ( ! $this->PDO ) {
        ...
        try {
          ...
          if ( ! $this->remote ) {
            $this->conn = new PDO( "{$this->dbType}:dbname={$this->dbName};host={$this->dbHost}", $this->dbUsername, $this->dbPassword );
          } else {
            $this->conn = new PDO( "{$this->dbType}:dbname={$this->dbName};host={$this->dbHost};port={$this->port}", $this->dbUsername, $this->dbPassword );
          }
    ...
    **/
    public function insert_id() {
      ...
      if ( ! $this->PDO ) {
        ...
        $this->insertID = $this->queryResult->lastInsertId();
